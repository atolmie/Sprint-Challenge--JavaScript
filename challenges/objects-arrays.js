...
zooAnimals.forEach(function (value) {
  const animalName = `Name: ${value.animal_name} Scientific: ${value.scientific_name}`;
...
const lowerCase = [];
zooAnimals.map(function (value) {
  console.log(value.animal_name.toLowerCase());
})
...
zooAnimals.filter(function (value) {
  if (value.population < 5) {
    largerPopulation.push(value)
  }
})
...
populationTotal.push (zooAnimals.reduce(function (accumulator, value) {
